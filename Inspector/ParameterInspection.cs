...
public class ParameterInspection
{
	...
	/// <summary>Generates an array of parameter information from the given collection of parameter definition</summary>
	/// <param name="parameters">The collection of parameters to look into</param>
	/// <returns>Returns the array of parameter information generated from the collection of parameter definitions</returns>
