...
public sealed class MethodInspection : Inspection
{
	#region Properties
	...
	/// <summary>Generates an array of method information from the given type and booleans</summary>
	...
	/// <param name="ignorePrivate">Set to true to ignore this field if it's private within the declaring type</param>
	/// <returns>Returns an array of method information</returns>
	...
	/// <summary>Generates an array of method information from the given collection of method definitions</summary>
