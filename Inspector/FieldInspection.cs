...
public sealed class FieldInspection : Inspection
{
	#region Properties
	...
	/// <summary>Generates an array of field information by locating it recursively and excluding or including static members</summary>
	...
	/// <param name="ignorePrivate">Set to true to ignore this field if it's private within the declaring type</param>
	/// <returns>Returns the list of field information</returns>
	...
	/// <summary>Generates an array of field information from a collection of field definitions</summary>
	...
	/// <param name="fields">The list of field information to look into</param>
	...
	/// <param name="list">The list of field information to remove duplicates from</param>
