...
public class GenericParameterInspection
{
	...
	/// <summary>Generates an array of generic parameter information from the given collection generic parameter</summary>
	/// <param name="generics">The collection of generic parameters to look into</param>
	/// <returns>Returns an array of generic parameter information</returns>
